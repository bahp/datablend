...
comb_file = '32dx-combined-books.csv'
...
tidy.haematocrit_lab.fillna(tidy.haematocrit_max)
tidy.haematocrit_lab.fillna(tidy.haematocrit_min)

# Remove columns
tidy = tidy.drop(columns=['haematocrit_max',
                          'haematocrit_min',
                          'haematocrit_high'])
