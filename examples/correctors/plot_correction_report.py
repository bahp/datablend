...
from datablend.core.repair.correctors import report_corrections
...
data = [
    ...
    {'id': '32dx-001', 'date': '2020/12/05', 'column': 'age', 'result': 234, 'unit': 'year'},
...
# Report all the corrections (changes)
corrections = report_corrections(transform, corrected)
