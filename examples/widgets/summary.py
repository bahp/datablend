...
from datablend.core.widgets import DateFromStudyDay
...
#transformed = DateFromStudyDay().fit_transform(template, transformed)
#transformed = EventWidget().fit_transform(template, transformed)

# Stack data
#stacked = StackWidget().fit_transform(template, transformed, index='study_number')
